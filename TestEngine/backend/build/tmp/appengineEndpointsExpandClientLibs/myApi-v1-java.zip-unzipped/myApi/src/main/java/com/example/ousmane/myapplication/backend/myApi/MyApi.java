 ...
 * on 2016-09-19 at 11:05:52 UTC 
 * Modify at your own risk.
 */

package com.example.ousmane.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJokesList extends MyApiRequest<com.example.ousmane.myapplication.backend.myApi.model.JokeBean> {
    ...
    protected GetJokesList() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.ousmane.myapplication.backend.myApi.model.JokeBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.ousmane.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.ousmane.myapplication.backend.myApi.model.MyBean.class);
